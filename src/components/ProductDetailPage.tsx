...
export const ProductDetailPage: React.FC<ProductDetailPageProps> = ({
  ...
  // Complementary Routine Products (pick 2 complementary items)
  const routineProducts = allProducts
    .filter((p) => p.id !== product.id)
    .slice(0, 2);

  const routineTotalPrice = product.price + routineProducts.reduce((sum, item) => sum + item.price, 0);
            ...
            <div className="flex items-center gap-3 justify-center pt-1">
              {galleryImages.map((img, idx) => (
                <button
                  ...
                  className={`w-16 h-16 sm:w-20 sm:h-20 rounded-xl p-1 border-2 transition-all overflow-hidden bg-slate-50 ${
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium tracking-wide mb-3">
                شناسه کالا: NZH-{product.id.toUpperCase()} | دسته‌بندی تخصصی {product.category}
              </p>
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>دارای سیب سلامت و پروانه رسمی غذا و دارو</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-3.5 h-3.5 text-[#0D7366] flex-shrink-0" />
                  <span>بافت بسیار سبک با جذب سریع بدون چربی</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-3.5 h-3.5 text-[#0D7366] flex-shrink-0" />
                  <span>هایپوآلرژنیک و مناسب حساس‌ترین پوست‌ها</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-3.5 h-3.5 text-[#0D7366] flex-shrink-0" />
                  <span> غنی‌شده با آنتی‌اکسیدان‌ها و ویتامین‌های مغذی</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-emerald-50/60 via-slate-50 to-white border border-emerald-100/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="bg-amber-100/60 text-amber-900 border border-amber-200/60 px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5">
                ...
                <span>+۱۵ امتیاز باشگاه مشتریان نوژاشاپ</span>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 py-3.5 px-6 rounded-2xl bg-[#0D7366] text-white font-extrabold text-sm shadow-xl shadow-[#0D7366]/25 hover:bg-[#0A584E] active:scale-98 transition-all flex items-center justify-center gap-2"
                >
            ...
            <div className="p-3.5 rounded-2xl bg-teal-50/60 border border-teal-100 flex items-center gap-3 text-xs text-teal-900">
              ...
              <div>
                ...
                <p className="text-slate-600 text-[11px]">
                  داروسازان نوژاشاپ به‌صورت آنلاین آماده پاسخگویی به سوالات شما هستند.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-600">
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
                  ...
                  <strong className="text-slate-800">۱۶۲۸۴۹۵۰۰۳۹۲۸۱</strong>
                </div>
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
                  <span>شماره سری ساخت (LOT):</span>
                  <strong className="text-slate-800">NZ-2024-8849</strong>
                </div>
              </div>
            </motion.div>
          )}
