...
class CategorySerializer(serializers.ModelSerializer):
    ...
    def get_children(self,o): return CategorySerializer(o.children.filter(is_active=True).annotate(product_count=__import__('django.db.models').db.models.Count('products')), many=True, context=self.context).data
